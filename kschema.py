...
class PropInt(PropDesc):
    ...
    def __init__(self, name, required=False, int_range=None,
        ...
        super(PropInt, self).__init__(name, 'int', required, cond_props, desc)
...
class PropReg(PropDesc):
    ...
    """
    def __init__(self, required=False, cond_props=None, desc=''):
        super(PropDesc, self).__init__('reg', 'reg', required, cond_props, desc)
...
class PropInterrupts(PropDesc):
    """An interrupts property

    This holds a list of interrupts used by this node
    """
    def __init__(self, count=None, required=False, cond_props=None,
                 desc=''):
        super(PropInterrupts, self).__init__('interrupts', 'interrupts',
                                             required, cond_props, desc=desc)
        self.count = count
...
class PropClocks(PropDesc):
    ...
    This holds a list of clocks used by this node
    """
    def __init__(self, count=None, required=False, cond_props=None,
                 desc=''):
        super(PropClocks, self).__init__('clocks', 'clocks', required,
                                         cond_props, desc)
        self.count = count
